...
<div class="row " style="margin-top: 70px;padding: 40px;" align="center"> 
        <div class="col-lg-6 col-md-6 ">
          <div class="cover">
            ...
            <div class="input">     
            <div class="mb-3 " >
                <h2 style="padding: 10px;">Car Parking </h2>
                <form id="parking-form">
                <label for="inputPassword" class="col-sm-2 col-form-label" style="font-size: 20px; padding:5px;">FullName</label>
                <div class="col-sm-10">
                  <input type="text" class="fullName" id="name">
                </div>
              </div>
      <div class="mb-3">
        <label for="inputPassword" class="col-sm-2 col-form-label" style="font-size: 20px; padding:5px;">PlateNumber</label>
        <div class="col-sm-10">
